...
/*        Field[] fields = c1.getFields();
        ...
        address.set(student, "南京");//给obj的成员变量address赋值南京
        System.out.println(student); //Student{name='null', age=0, addrss='南京'}
*/
        /*Constructor<Student> constructor1 = c1.getConstructor();
        Student student1 = constructor1.newInstance();
        Field name = c1.getDeclaredField("name");
        name.setAccessible(true);
        name.set(student1,"planb");
        System.out.println(student1);//Student{name='planb', age=0, addrss='null'}
*/
        Method declaredMethods = c1.getDeclaredMethod("method3", String.class, int.class);
        declaredMethods.setAccessible(true);
        Constructor<Student> constructor = c1.getConstructor();
        Student student = constructor.newInstance();
        Object invoke = declaredMethods.invoke(student, "4",8);
